								...
								<tbody>
									...
									?>
											<tr>
												...
												<td class="product-price"><span class="amount"><?= number_format($tv_2['gia'], 0, ",", ".") ?> VNĐ</span></td>
												...
												<td class="product-subtotal"><?= number_format($tien, 0, ",", ".") ?> VNĐ</td>
									...
									<table class="float-md-right">
										<tbody>
											...
											<tr class="order-total">
												<td>
													<strong><span class="amount"><?= number_format($tong_cong, 0, ",", ".") ?> VNĐ</span></strong>
												</td>
											</tr>
										</tbody>
									</table>
